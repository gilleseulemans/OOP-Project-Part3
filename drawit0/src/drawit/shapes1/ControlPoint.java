...
public class ControlPoint {
	...
	/**
	 * If this control point corresponds to a polygon vertex, 
	 * remove the vertex from the polygon's list of vertices. Otherwise, throw an UnsupportedOperationException.
	 */
	public void remove() {
